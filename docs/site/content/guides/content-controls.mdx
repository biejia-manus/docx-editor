...
shows the state glyph. If the control's content holds no paragraph and no run, such as
foreign markup, the write is refused instead of replacing that content.
